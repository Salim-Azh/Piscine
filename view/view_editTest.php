<?php include_once("header.php"); ?>
 ...
 <div class=" mt-5 mb-5 container">
 	...
 	<hr style="width: 50%;">
 	<form method="POST" action="../controller/ctrl_saveEditTest.php" onsubmit="this.ajouter_test.disabled = true;">
		<div >
			<label for='nameTest' class="d-flex flex-row ">Nom du test</label>
			<?php 
				echo('<input type="text" class="form-control" value="'.$testName.'" placeholder="Nom du test" id="nameTest" name="nameTest"required />'); 
			?>
		</div>
