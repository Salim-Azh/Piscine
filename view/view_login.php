...
<?php include("header.php");?>
 	<div class="container">
		<!-- on cree un conteneur pour espacer le contenu des bords de la fenetre -->
		<div class="container mt-5 mb-5">
			<!-- on cree un nouveau conteneur row qui est une ligne dont les composants sont alignes au centre -->
			<div class="row align-items-center">
				...
				<!-- On cree une seconde colonne pour le formulaire de connexion -->
				<div class="col pt-sm-5">
					<div class="text-center">
						...
						<p class=" mb-3 text-muted">&copy; 2020</p>
					</div>
				</div>
		...
		<div class="container mt-5 mb-5">
			<div class="d-flex flex-row">
				...
				<div id="t1" class="d-flew col align-items-center ml-3 text-center">
					<p>Le toeic est une certification permettant de tester le niveau d’anglais de toutes les personnes se présentant à l’examen. Une note finale est attribuée /995, constituée de 495 points sur une compréhension orale (listening) et 495 points sur une compréhension écrite (reading). A Polytech, il est obligatoire de valider le TOEIC pour pouvoir être diplômé en tant qu'ingénieur. Pour que votre TOEIC soit validé, vous devez obtenir la note de 775/995, et votre TOEIC sera valide pendant toute votre durée de scolarité à Polytech, et 2 ans après. Ce site vous permettra de passer différents TOEIC blancs mis en ligne par vos professeurs, et de pouvoir consulter vos résultats sous forme de statistiques.</p>
				</div>
			</div>
		</div>	
